...
Se corrigió un problema táctil de la barra rápida: las zonas invisibles de control de cámara
podían quedar por encima de los objetos del lado derecho. La barra ahora tiene prioridad táctil,
por lo que todos sus objetos se pueden seleccionar.

También se redujo la carga en celular:
- 30 FPS por defecto.
- Render distance 2.
- Simulation distance 1.
- Pixel ratio máximo aproximado 0.72.
- Nubes ocultas en móvil.
- Máximo 4 mobs, 40 partículas y 18 drops en el preset móvil inicial.
- IA/proyectiles móviles actualizados a ~10 Hz.
- Drops actualizados a ~15 Hz.
- Render, jugador y cámara siguen respondiendo cada frame.
- Presets Bajo/Medio/Alto usan valores distintos para móvil y PC.


## Corrección móvil
Se corrigió el botón JUGAR: las zonas táctiles invisibles ya no quedan por encima de la pantalla de inicio.


## Corrección de arranque

Se corrigió un error de JavaScript que detenía todo el juego antes de registrar el botón JUGAR.
La detección de dispositivo táctil ahora se declara antes de crear el renderer de Three.js,
por lo que el inicio funciona tanto en PC como en celular.
